...
export declare function precacheFiberNode(hostInst: ReactReconciler.OpaqueHandle, node: Instance | TextInstance): void;
export declare function getInternalInstance(node: Instance): ReactReconciler.OpaqueHandle | null;
/**
...
export declare function markContainerAsRoot(hostRoot: ReactReconciler.Fiber, node: Container): void;
export declare function unmarkContainerAsRoot(node: Container): void;
export declare function getInternalContainerInstance(node: Container): any;
