...
import { Instance, Container, PublicInstance, SuspenseInstance } from "../shared/HostConfigTypes";
import { NSVText } from "../nativescript-vue-next/runtime/nodes";
export declare const reactReconcilerInst: ReactReconciler.Reconciler<Container, Instance, NSVText, SuspenseInstance, PublicInstance>;
