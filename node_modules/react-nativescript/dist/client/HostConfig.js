...
import { precacheFiberNode, updateFiberProps, getInternalInstance, getInternalContainerInstance, } from "./ComponentTree";
...
const hostConfig = {
    ...
    getInstanceFromNode: (instance) => {
        var _a;
        const internalInstance = (_a = getInternalInstance(instance)) !== null && _a !== void 0 ? _a : getInternalContainerInstance(instance);
        if (internalInstance) {
            if (internalInstance.tag === HostComponent ||
