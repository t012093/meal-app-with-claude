...
if (!__TEST__) {
    ...
    registerElement('dockLayout', () => require('@nativescript/core').DockLayout, { viewFlags: 4 /* NSVViewFlags.LAYOUT_VIEW */ });
    registerElement('flexboxLayout', () => require('@nativescript/core').FlexboxLayout, { viewFlags: 4 /* NSVViewFlags.LAYOUT_VIEW */ });
    registerElement('gridLayout', () => require('@nativescript/core').GridLayout, { viewFlags: 4 /* NSVViewFlags.LAYOUT_VIEW */ });
    registerElement('stackLayout', () => require('@nativescript/core').StackLayout, { viewFlags: 4 /* NSVViewFlags.LAYOUT_VIEW */ });
    registerElement('wrapLayout', () => require('@nativescript/core').WrapLayout, { viewFlags: 4 /* NSVViewFlags.LAYOUT_VIEW */ });
    // ContentViews
    registerElement('contentView', () => require('@nativescript/core').ContentView, { viewFlags: 2 /* NSVViewFlags.CONTENT_VIEW */ });
    registerElement('scrollView', () => require('@nativescript/core').ScrollView, { viewFlags: 2 /* NSVViewFlags.CONTENT_VIEW */ });
