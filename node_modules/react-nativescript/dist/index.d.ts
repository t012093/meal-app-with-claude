...
export declare function createPortal(children: ReactNodeList, container: Container, key?: string | null): ReactPortal;
 ...
 */
export declare function render(reactElement: ReactNodeList, domElement: Container | null, callback?: () => void | null | undefined, containerTag?: string | null, strictMode?: boolean): import("./shared/HostConfigTypes").PublicInstance | React.Component<any, any, any>;
/**
 ...
 */
export declare function start(app: ReactNodeList): void;
declare global {
    module JSX {
